...
$.notify({
	...
	title: 'HairSara',
	message: 'Chào Mừng Bạn Quay Lại Trang Quản Trị',
},{
	type: 'secondary',
	placement: {
		from: "bottom",
	...
	$('.btn-save').click(function () {
		...
		$.ajax({
			...
			success: function (response) {
				// Xử lý thành công, có thể làm gì đó, ví dụ như cập nhật lại dữ liệu trên trang
				location.reload();
			},
			error: function () {
				// Xử lý lỗi, có thể thông báo cho người dùng hoặc thực hiện các hành động khác
				alert('An error occurred while saving.');
			}
		});

		$('#editPopup_@item.Id').modal('hide');
	});
});
